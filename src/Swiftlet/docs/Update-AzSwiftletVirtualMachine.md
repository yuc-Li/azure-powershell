...
online version: https://docs.microsoft.com/en-us/powershell/module/az.swiftlet/update-azswiftletvirtualmachine
schema: 2.0.0
---

# Update-AzSwiftletVirtualMachine
...
```
Update-AzSwiftletVirtualMachine -ResourceGroupName <String> -VMName <String> [-SubscriptionId <String>]
 [-Port <IPort[]>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzSwiftletVirtualMachine -InputObject <ISwiftletIdentity> [-Port <IPort[]>] [-Tag <Hashtable>]
