...
online version: https://docs.microsoft.com/en-us/powershell/module/az.swiftlet/remove-azswiftletvm
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzSwiftletVM -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzSwiftletVM -InputObject <ISwiftletIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
