...
online version: https://docs.microsoft.com/en-us/powershell/module/az.swiftlet/stop-azswiftletvirtualmachine
schema: 2.0.0
---

# Stop-AzSwiftletVirtualMachine
...
### Stop (Default)
```
Stop-AzSwiftletVirtualMachine -ResourceGroupName <String> -VMName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StopViaIdentity
```
Stop-AzSwiftletVirtualMachine -InputObject <ISwiftletIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
