...
online version: https://docs.microsoft.com/en-us/powershell/module/az.swiftlet/get-azswiftletvirtualmachine
schema: 2.0.0
---

# Get-AzSwiftletVirtualMachine
...
### List (Default)
```
Get-AzSwiftletVirtualMachine [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzSwiftletVirtualMachine -ResourceGroupName <String> -VMName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzSwiftletVirtualMachine -InputObject <ISwiftletIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### List1
```
Get-AzSwiftletVirtualMachine -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
