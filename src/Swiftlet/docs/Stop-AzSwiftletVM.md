...
online version: https://docs.microsoft.com/en-us/powershell/module/az.swiftlet/stop-azswiftletvm
schema: 2.0.0
---
...
### Stop (Default)
```
Stop-AzSwiftletVM -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StopViaIdentity
```
Stop-AzSwiftletVM -InputObject <ISwiftletIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
