...
online version: https://docs.microsoft.com/en-us/powershell/module/az.swiftlet/remove-azswiftletvirtualmachine
schema: 2.0.0
---

# Remove-AzSwiftletVirtualMachine
...
### Delete (Default)
```
Remove-AzSwiftletVirtualMachine -ResourceGroupName <String> -VMName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzSwiftletVirtualMachine -InputObject <ISwiftletIdentity> [-DefaultProfile <PSObject>] [-AsJob]
