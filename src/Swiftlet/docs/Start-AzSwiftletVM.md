...
online version: https://docs.microsoft.com/en-us/powershell/module/az.swiftlet/start-azswiftletvm
schema: 2.0.0
---
...
### Start (Default)
```
Start-AzSwiftletVM -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StartViaIdentity
```
Start-AzSwiftletVM -InputObject <ISwiftletIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
