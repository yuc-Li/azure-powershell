...
online version: https://docs.microsoft.com/en-us/powershell/module/az.swiftlet/start-azswiftletvirtualmachine
schema: 2.0.0
---

# Start-AzSwiftletVirtualMachine
...
### Start (Default)
```
Start-AzSwiftletVirtualMachine -ResourceGroupName <String> -VMName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StartViaIdentity
```
Start-AzSwiftletVirtualMachine -InputObject <ISwiftletIdentity> [-DefaultProfile <PSObject>] [-AsJob]
