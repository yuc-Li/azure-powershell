...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'Get-AzWvdUserSessionHostPoolLevel.Recording.json'
...
Describe 'Get-AzWvdUserSessionHostPoolLevel' {
        It 'List' {
        $userSessions = Get-AzWvdUserSessionHostPoolLevel -SubscriptionId $env.SubscriptionId `
