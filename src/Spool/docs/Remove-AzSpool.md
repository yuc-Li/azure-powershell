...
online version: https://docs.microsoft.com/en-us/powershell/module/az.spool/remove-azspool
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzSpool -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzSpool -InputObject <ISpoolIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
...
Removes all Spool Resources presented by the pipeline.
Allows for deleting multiple resources at once and for additional filtering.
