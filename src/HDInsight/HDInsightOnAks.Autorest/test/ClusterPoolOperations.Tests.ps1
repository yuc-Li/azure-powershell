...
Describe 'ClusterPoolOperations' {
    BeforeAll {
        ...
        $LogAnalyticProfileWorkspaceId = "/subscriptions/10e32bab-26da-4cc4-a441-52b318f824e6/resourcegroups/yuchenpsgroup/providers/microsoft.operationalinsights/workspaces/yuchentestworkspace"
